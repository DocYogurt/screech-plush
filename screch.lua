local Item = game:GetObjects("rbxassetid://11980064197")[1]
...
local exampleTool = game:GetObjects("rbxassetid://11980064197")[1]
...
local custom = {
    ...
    Desc = "我去, screech抱枕？",  --first line

    Reason = "不知道哪里来的", --change this for second line of the badgs desc

    BadgeId = 43566570, --change badge id for image
